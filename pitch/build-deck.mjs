    ...
    <div style="flex:1;padding:0;display:grid;grid-template-rows:auto 1fr auto;gap:2.6vh">
      ...
      <div data-anim="bottom" style="display:grid;grid-template-rows:auto auto;gap:1.6vh;border-top:1px solid rgba(255,255,255,.22);padding-top:2vh">
        <div data-anim="lead" class="lead" style="max-width:58ch;color:rgba(255,255,255,.86)">
          <span class="en">A Sui execution console that scores maker risk, creates a guard policy, places a real DeepBook order, records an on-chain receipt, then cancels.</span>
          <span class="zh">一个 Sui 执行控制台：先评估 maker 风险，再创建守卫策略，真实下 DeepBook 订单，写链上凭证，最后取消订单。</span>
        </div>
...
<section class="slide" data-layout="S11" data-animate="timeline-walk">
  <div class="canvas-card">
    ...
    <div data-anim="head" style="display:flex;flex-direction:column;gap:1.4vh">
      ...
      <h2 class="h-xl-zh" style="font-size:min(5.6vw,9.8vh)">
        <span class="en">Five clicks that prove the product</span>
        <span class="zh">五个动作，证明产品成立</span>
      </h2>
    </div>
    <div class="timeline-h nav-safe-bottom" data-anim="timeline">
      <div class="tl-row">
        ...
        <div class="th-node up">
          <div class="label"><div class="yr">05</div><div class="name"><span class="en">Verify + cancel</span><span class="zh">验证并取消</span></div><div class="desc"><span class="en">indexer + receipt + cancel</span><span class="zh">indexer + 凭证 + 取消</span></div></div><div class="dot"></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="canvas-card">
    ...
    <div class="stack-row" data-anim="stack">
      ...
      <div class="stack-block b-grey">
        ...
        <div class="layer-desc"><span class="en">The workflow does not leave a mystery order behind; cancellation is part of the operating loop.</span><span class="zh">流程不会留下未知订单；取消动作本身就是操作闭环的一部分。</span></div>
...
<section class="slide" data-layout="S16" data-animate="field-notes">
  <div class="canvas-card">
    ...
    <div class="sub-grid-3-2" data-anim="grid">
      ...
      <div class="sub-card accent"><div class="nb-corner">06</div><div class="ttl"><span class="en">Cancel closes the loop.</span><span class="zh">取消让流程闭环。</span></div><div class="desc"><span class="en">A mature workflow proves entry and exit.</span><span class="zh">成熟流程要证明进入和退出。</span></div></div>
    </div>
  </div>
</section>
...
<section class="slide" data-layout="S02" data-animate="progression">
  <div class="canvas-card">
    ...
    <div class="timeline-v" data-anim="timeline">
      <div class="tl-node accent"><div class="dot"></div><div class="yr">V1</div><div class="multi">Live</div><div class="desc"><span class="en">Wallet flow, GuardPolicy, guarded ask, DeepBook indexer proof, cancel.</span><span class="zh">钱包流程、GuardPolicy、受控卖单、DeepBook indexer 证明、取消订单。</span></div></div>
